...
export const workflows: Workflow[] = [
  ...
  w("screen-vendors-against-exclusion-lists", "Screen vendors against exclusion lists", "Monitor", "Check vendors against OIG and OFAC on a schedule and keep the evidence.", "exclusion-monitor", { tool: "oig-search", template: "exclusion-screening-log", glossary: ["oig-exclusion", "ofac-sdn-list"], stack: ["exclusion-monitor"] }),
  ...
  w("send-policy-acknowledgments", "Send policy acknowledgments", "Collect", "Distribute a policy and collect signed acknowledgments with version history.", "policy-acknowledgment-tracker", { tool: "policy-acknowledgment-link-maker", template: "policy-acknowledgment", glossary: ["policy-acknowledgment", "attestation"], stack: ["policy-acknowledgment-tracker"] }),
  w("track-policy-version-acceptance", "Track policy version acceptance", "Audit", "Know who accepted which version of which policy, and when.", "policy-acknowledgment-tracker", { tool: "policy-acknowledgment-link-maker", template: "policy-acknowledgment", glossary: ["version-history", "attestation"], stack: ["policy-acknowledgment-tracker"] }),
...
export const industries: Industry[] = [
  { slug: "healthcare", name: "Healthcare", headline: "Keep vendors, staff, and credentials compliant — and provable.", pains: ["Exclusion screening (OIG) must be continuous, not annual", "Vendor insurance lapses create liability exposure", "Staff certifications expire on a rolling basis"], documents: ["W-9s", "Certificates of insurance", "OIG exclusion checks", "Staff certifications", "Policy acknowledgments"], workflows: ["screen-vendors-against-exclusion-lists", "track-coi-expirations", "monitor-certification-expirations"], products: ["exclusion-monitor", "coi-tracker", "training-record-tracker"], templates: ["exclusion-screening-log", "coi-tracking-log"], guides: ["how-to-screen-vendors-against-the-oig-list", "oig-sam-and-ofac-what-healthcare-providers-must-screen", "how-to-prepare-for-a-cms-exclusion-screening-audit", "how-to-track-coi-expirations", "how-to-screen-employees-for-exclusions"] },
  ...
  { slug: "staffing", name: "Staffing", headline: "Onboard, screen, and keep credentials current at scale.", pains: ["High-volume onboarding documents", "Exclusion and certification checks per placement", "Re-acknowledgment when policies change"], documents: ["W-9s", "Certifications", "Policy acknowledgments", "Exclusion checks"], workflows: ["build-vendor-onboarding-packets", "screen-employees-against-exclusion-lists", "track-training-records"], products: ["vendor-packet", "exclusion-monitor", "training-record-tracker"], templates: ["vendor-onboarding-checklist", "training-record-log"], guides: ["how-to-screen-medical-staffing-vendors-for-exclusions", "how-to-screen-employees-for-exclusions", "how-often-to-re-screen-for-exclusions"] },
  ...
  { slug: "professional-services", name: "Professional Services", headline: "Client and vendor documents, signed and on file.", pains: ["Engagement letters and signatures", "Vendor W-9s and insurance", "Policy acknowledgments"], documents: ["Engagement letters", "W-9s", "COIs", "Policies"], workflows: ["send-documents-for-signature", "collect-w9s", "send-policy-acknowledgments"], products: ["simple-signer", "w9-collector", "policy-acknowledgment-tracker"], templates: ["signature-request", "policy-acknowledgment"], guides: [] },
  { slug: "nonprofit", name: "Nonprofit", headline: "Grant, vendor, and volunteer documents without the overhead.", pains: ["Grant compliance documentation", "Vendor and contractor W-9s", "Volunteer policy acknowledgments"], documents: ["W-9s", "COIs", "Policy acknowledgments", "Grant documents"], workflows: ["collect-w9s", "send-policy-acknowledgments", "build-audit-trails"], products: ["w9-collector", "policy-acknowledgment-tracker", "platform"], templates: ["vendor-w9-request", "policy-acknowledgment"], guides: [] },
