...
export const industries: Industry[] = [
  ...
  { slug: "staffing", name: "Staffing", headline: "Onboard, screen, and keep credentials current at scale.", pains: ["High-volume onboarding documents", "Exclusion and certification checks per placement", "Re-acknowledgment when policies change"], documents: ["W-9s", "Certifications", "Policy acknowledgments", "Exclusion checks"], workflows: ["build-vendor-onboarding-packets", "screen-employees-against-exclusion-lists", "track-training-records"], products: ["vendor-packet", "exclusion-monitor", "training-record-tracker"], templates: ["vendor-onboarding-checklist", "training-record-log"], guides: [] },
