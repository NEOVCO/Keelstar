...
const coreGlossary: GlossaryTerm[] = [
  ...
  g("policy-acknowledgment", "Policy Acknowledgment", "A policy acknowledgment is a record that a person received, read, and accepted a specific version of a policy.", "Acknowledgment isn't one-and-done — new hires and policy revisions restart the cycle. The evidence that matters is which version each person accepted, and when.", { product: "policy-acknowledgment-tracker", workflow: "send-policy-acknowledgments", examples: "Every employee acknowledges v3 of the security policy after it's updated.", related: ["version-history", "attestation"] }),
...
const briefGlossary: [string, string, string][] = [
  ...
  ["evergreen-contract", "Evergreen Contract", "A contract that renews automatically and indefinitely until canceled."],
  ...
  // ["sam-exclusion", "SAM Exclusion", "..."] — disabled (not implementing)
...
const coreCompare: Compare[] = [
  ...
  c("keelstar-vs-docusign", "Keelstar vs DocuSign", "a standalone e-signature tool", "simple-signer", {
    fullCopy: true,
    forKeelstar: "Teams that send documents for signature and also want those documents monitored — for renewals, acknowledgments, and audit — on one platform.",
...
function makeCompareFiller(): Compare[] {
  const items: [string, string, string, string][] = [
    ...
    ["keelstar-vs-email-for-policy-acknowledgments", "Keelstar vs Email for Policy Acknowledgments", "email", "policy-acknowledgment-tracker"],
    ["keelstar-vs-spreadsheets-for-policy-tracking", "Keelstar vs Spreadsheets for Policy Tracking", "spreadsheets", "policy-acknowledgment-tracker"],
...
export const templates: Template[] = [
  ...
  tpl("policy-acknowledgment", "Policy Acknowledgment", "HR Compliance", "Distribute a policy and collect signed acknowledgments with versioning.", "HR and compliance teams.", "send-policy-acknowledgments", "policy-acknowledgment-tracker", { glossary: ["policy-acknowledgment", "version-history"] }),
