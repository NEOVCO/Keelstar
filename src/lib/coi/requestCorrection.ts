...
import { vendorCoiCorrectionEmail } from "@/lib/email/templates/coi";
...
export async function sendCoiCorrectionEmail(workflowId: string, reason: string) {
  ...
  const { data: task } = await supabase
    ...
    .insert({
      ...
      title: "Upload corrected certificate of insurance",
      description: reason,
      status: "pending",
  ...
  const email = vendorCoiCorrectionEmail({
