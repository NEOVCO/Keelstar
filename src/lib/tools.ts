...
export const tools: Tool[] = [
  ...
  t("policy-acknowledgement-link-maker", "Policy Acknowledgement Link Maker", "Create a link that collects a signed acknowledgement of a policy.", "upload", "Upload a policy document", "policy-acknowledgement-tracker", "send-policy-acknowledgements", { glossary: ["policy-acknowledgement", "attestation"], template: "policy-acknowledgement" }),
