...
const scaffoldProducts: Product[] = [
  ...
  },
  {
    ...
    sub: "Screen vendors and employees against OIG, OFAC, and SAM exclusion lists on a schedule — and keep dated evidence of every check.",
    ...
    whatItDoes: [
      "Screens names against OIG, OFAC (SDN), and SAM exclusion lists.",
    ...
    faqs: [
      { q: "Which lists are covered?", a: "OIG LEIE, OFAC SDN, and SAM exclusions, with a dated record of each screen." },
    ...
    relatedTools: ["oig-search", "ofac-search", "sam-search"],
  ...
  },
  {
    ...
    relatedWorkflows: ["send-documents-for-signature", "send-policy-acknowledgements", "build-vendor-onboarding-packets"],
    relatedTools: ["pdf-signer", "policy-acknowledgement-link-maker", "vendor-onboarding-packet-generator"],
  ...
  {
    slug: "policy-acknowledgement-tracker",
    name: "Policy Acknowledgement Tracker",
    cluster: "HR Compliance",
    node: "Collect",
    job: "Send policies, collect acknowledgements, and keep version history.",
    sub: "Distribute a policy, collect signed acknowledgements from everyone who needs to read it, and keep a version-controlled record of who accepted which version when.",
    ...
    whatItDoes: [
      "Sends a policy to a defined group and collects acknowledgements.",
      "Tracks who has and hasn't acknowledged, with reminders.",
      "Versions the policy so a change triggers re-acknowledgement.",
    ...
    how: [
      ...
      { title: "Version", body: "Update the policy and Keelstar requests re-acknowledgement of the new version." },
    ],
    monitoring:
    ...
    audit: "Every acknowledgement is recorded against a specific policy version with a timestamp, ready to export as proof.",
    faqs: [
      { q: "What happens when a policy changes?", a: "Keelstar versions the policy and requests re-acknowledgement from the group, keeping each person's accepted version on record." },
      { q: "Can I see who hasn't acknowledged?", a: "Yes. Coverage is visible at a glance, and reminders go to anyone outstanding." },
    ],
    relatedWorkflows: ["send-policy-acknowledgements", "track-policy-version-acceptance", "build-audit-trails"],
    relatedTools: ["policy-acknowledgement-link-maker", "audit-trail-export-preview", "training-expiration-calculator"],
    relatedGlossary: ["policy-acknowledgement", "version-history", "attestation"],
    relatedTemplates: ["policy-acknowledgement", "audit-evidence-pack"],
    relatedCompare: ["keelstar-vs-email-for-policy-acknowledgements", "keelstar-vs-spreadsheets-for-policy-tracking"],
  },
  {
    ...
    relatedTools: ["training-expiration-calculator", "audit-trail-export-preview", "policy-acknowledgement-link-maker"],
