...
export const MODULES: ProductModule[] = [
  {
    ...
    emptyStateDescription: "Send a secure link to someone in your directory and track the submission without email threads.",
  ...
  },
  {
    ...
    routes: { app: appRoute("contracts-risk"), new: "/app/apps/contracts-risk" },
    crossSell: ["contracts"],
  },
  {
    ...
    slug: "exclusions",
    category: "compliance",
    jobToBeDone: "Monitor vendor and employee names against OIG exclusion lists.",
    ...
    emptyStateDescription: "Run and schedule checks against OIG exclusion lists.",
  ...
  },
  {
    ...
    routes: { app: appRoute("policies"), new: "/app/apps/policies" },
    crossSell: ["training"],
  },
  {
    id: "training_record",
    ...
    routes: { app: appRoute("training"), new: "/app/apps/training" },
    crossSell: ["policies"],
  },
  {
    id: "invoice_approval",
    ...
    routes: { app: appRoute("invoices"), new: "/app/apps/invoices" },
    crossSell: [],
  },
  {
    id: "simple_signer",
    ...
    routes: { app: appRoute("signer"), new: "/app/apps/signer" },
    crossSell: [],
  },
];
